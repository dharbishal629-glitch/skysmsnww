  ...
  return (
    <div className="mt-3">
      <div className="flex items-center justify-between mb-2">
        <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-[0.14em]">
          {label}
        </span>
      ...
      <div className="relative rounded-xl border border-slate-800 dark:border-slate-700 bg-[#0d1117] dark:bg-[#080c18] overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-[#c8f169]/40 via-[#c8f169]/20 to-transparent" />
        <pre
          style={{
            padding: "14px 18px",
            overflowX: "auto",
  ...
  return (
    <div className="space-y-1">
      <div className="flex items-center gap-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 px-4 py-3 overflow-x-auto">
        ...
        <code className="text-[13px] font-mono text-[#c8f169] dark:text-[#78e2dc] whitespace-nowrap">
          {path}
        </code>
      </div>
      <p className="text-[13px] text-slate-600 dark:text-slate-400 leading-relaxed px-1 py-1">
        {note}
      </p>

      {payload && (
        <CodeBlock label="Payload" copyText={payload}>
          {payload}
        </CodeBlock>
      )}
      <CodeBlock label="Response" copyText={response}>
        {response}
      </CodeBlock>
      <CodeBlock label="cURL" copyText={curl}>
        {curl}
      </CodeBlock>
    </div>
  );
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        response: JSON.stringify(
          { available: 4820, price: 0.15, estimatedWait: "instant" },
          null,
          2,
        ),
    ...
    endpoints: [
      ...
      },
      {
        ...
        response: JSON.stringify(
          {
            rentals: [
              { id: "rnt_01J2K4P8", serviceName: "Telegram", status: "active" },
            ],
            total: 1,
          },
          null,
        ...
        response: JSON.stringify(
          {
            id: "rnt_01J2K4P8",
            status: "sms_received",
            messages: [{ body: "Your code: 481624", code: "481624" }],
          },
          null,
          2,
        ),
      ...
      },
      {
        ...
        response: JSON.stringify(
          { id: "rnt_01J2K4P8", status: "active", messages: [] },
          null,
          2,
        ),
...
const ERROR_ROWS = [
  ...
  },
  {
    ...
    label: "Unauthorized",
    type: "error" as const,
    desc: "Invalid or missing API key.",
  },
  {
    code: "402",
  ...
  },
  {
    ...
    label: "Conflict",
    type: "warning" as const,
    desc: "No numbers available right now.",
  },
  {
    code: "429",
    label: "Rate Limited",
    type: "warning" as const,
    desc: "60 requests per minute limit exceeded.",
  },
  {
    code: "500",
    label: "Server Error",
    type: "error" as const,
    desc: "Internal error — contact support.",
  },
];
...
export default function ApiDocs() {
  ...
  return (
    <div
      className="api-docs-page flex gap-0 sky-page"
      data-sky-page="api-docs"
    ...
    >
              ...
              return (
                <a
                  ...
                  className={`flex items-center gap-2.5 px-3 py-2 rounded-xl text-[13px] font-medium transition-all ${
                    isActive
                      ? "bg-[#c8f169]/10 dark:bg-[#c8f169]/15 text-[#c8f169] border border-[#c8f169]/15 dark:border-[#c8f169]/25"
                      : "text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800"
                  }`}
                >
                  <n.icon
                    className={`h-3.5 w-3.5 shrink-0 ${isActive ? "text-[#c8f169]" : "text-slate-400 dark:text-slate-500"}`}
                  />
                  {n.label}
      ...
      <main className="flex-1 min-w-0 p-6 space-y-6 overflow-x-hidden">
        {/* Overview */}
        <section id="overview">
          <div className="rounded-2xl border border-[#c8f169]/15 dark:border-[#c8f169]/20 bg-gradient-to-br from-[#c8f169]/5 dark:from-[#c8f169]/8 to-transparent overflow-hidden relative shadow-sm">
            <div
              className="absolute inset-0 pointer-events-none"
              style={{
                backgroundImage:
                  "linear-gradient(rgba(69,116,255,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(69,116,255,0.04) 1px, transparent 1px)",
            ...
            <div className="relative p-7">
              ...
              <div className="flex items-start gap-4 mb-6">
                <div className="h-12 w-12 rounded-2xl bg-[#c8f169] flex items-center justify-center shadow-lg flex-shrink-0">
                  <Terminal className="h-6 w-6 text-white" />
                </div>
                <div>
                  <div className="text-[10px] font-bold text-[#c8f169] uppercase tracking-[0.18em] mb-1">
                    Public API · v1
                  </div>
                  ...
                  <p className="text-[14px] text-slate-500 dark:text-slate-400 mt-1">
                    Full REST API for renting numbers, polling SMS, and managing
                    your account.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {[
                  ...
                  >
                    <Icon className="h-3 w-3 text-[#c8f169]" />
                    {label}
                  </div>
                ))}
              </div>
              ...
              <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/60 p-4 shadow-sm">
                <div className="flex items-start gap-3">
                  <div className="h-8 w-8 rounded-lg bg-[#c8f169]/10 border border-[#c8f169]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Lock className="h-4 w-4 text-[#c8f169]" />
                  </div>
                  <div className="text-[13px] text-slate-700 dark:text-slate-300 leading-relaxed">
                    <p className="mb-1">
                      ...
                      <code className="bg-slate-100 dark:bg-slate-700 text-[#c8f169] dark:text-[#78e2dc] px-1.5 py-0.5 rounded text-[12px] font-mono">
                        X-API-Key
                      </code>{" "}
          ...
          <section key={sec.id} id={sec.id}>
            <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-sm overflow-hidden">
              ...
              <div className="flex items-center gap-3 px-6 py-4 border-b border-slate-100 dark:border-slate-700/80 bg-slate-50/50 dark:bg-slate-800/30">
                <div className="w-1 h-5 rounded-full bg-gradient-to-b from-[#c8f169] to-[#78e2dc] flex-shrink-0" />
                ...
                <span className="ml-auto text-[11px] font-semibold text-slate-400 dark:text-slate-500 bg-slate-100 dark:bg-slate-800 rounded-lg px-2 py-0.5">
                  {sec.endpoints.length} endpoint
                  {sec.endpoints.length !== 1 ? "s" : ""}
                </span>
              </div>
              ...
              {ERROR_ROWS.map((row) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[13px] font-semibold text-slate-700 dark:text-slate-300 w-36 flex-shrink-0">
                      {row.label}
                    </span>
