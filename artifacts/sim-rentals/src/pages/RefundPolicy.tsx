...
export default function RefundPolicy() {
  return (
    <div
      className="min-h-screen bg-white dark:bg-[#080c18] sky-page"
      data-sky-page="refund-policy"
    >
      {/* Header */}
        ...
        <Reveal variant="up" delay={60}>
          <div className="rounded-2xl p-6 mb-8 border border-red-200 dark:border-red-900/40 bg-red-50 dark:bg-red-900/10">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-900 dark:text-white text-lg mb-2">
                  No Refunds on Payments
                </div>
                <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
                  <strong className="text-slate-900 dark:text-white">
                    Once a payment has been processed for adding funds to your
                    account, no refund is provided under any circumstances.
                  </strong>{" "}
                  Cryptocurrency transactions are irreversible by nature. Please
                  ensure you intend to use the service before making any
                  payment.
                </p>
              </div>
            </div>
              ...
              {[
                {
                  step: "1",
                  title: "Rent a number",
                  desc: "Pay from your account balance to activate a number for 20 minutes.",
                },
                {
                  step: "2",
                  title: "Wait for SMS or cancel",
                  desc: "If no SMS arrives and you cancel, or the window expires — the refund triggers automatically.",
                },
                {
                  step: "3",
                  title: "Balance restored instantly",
                  desc: "The exact amount you paid for that rental is returned to your account balance with no delay.",
                },
              ].map((item) => (
                <div
                  key={item.step}
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {faqs.map((faq, i) => (
                <div
                  key={i}
                  className="rounded-2xl p-5 border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-800/40"
                >
        ...
        <Reveal variant="up" delay={180}>
          <div className="rounded-2xl p-6 text-center border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-800/40">
            <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">
              Have a question not covered here? Contact our support team from
