    ...
    >
      ...
      <main className="mx-auto max-w-4xl px-4 pb-24 pt-14 sm:px-6 lg:px-8">
        ...
        <Reveal variant="up" delay={60}>
          <div className="rounded-2xl p-6 mb-8 flex items-start gap-4 border-l-4 border-l-[#10b981] border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-800/40">
            <Scale className="h-5 w-5 text-[#10b981] shrink-0 mt-0.5" />
            <div>
              <div className="font-bold text-slate-900 dark:text-white mb-1">
                Please read these terms carefully
              </div>
              <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
                These Terms of Service govern your use of SKY SMS. By using our
                service, you agree to these terms in full. If you disagree with
        ...
        <Reveal variant="up" delay={200}>
          <div className="mt-10 rounded-2xl p-6 text-center border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-800/40">
            <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">
              By using SKY SMS, you acknowledge that you have read and agree to
