    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6 page-enter">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[0, 1, 2, 3].map(i => (
            <div key={i} className="rounded-2xl border border-slate-200 bg-white p-5 space-y-3 shadow-sm">
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-7 page-enter">
      ...
      <div>
        ...
        <p className="text-[13px] text-slate-500 mt-0.5">Here's an overview of your account.</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        {stats.map(({ label, value, sub, link, accent }) => (
          <Link key={label} href={link}>
            <div
              className="group rounded-2xl border border-slate-200 bg-white p-5 cursor-pointer hover:border-[#4574FF]/30 hover:shadow-md transition-all duration-200 relative overflow-hidden shadow-sm"
              style={{
