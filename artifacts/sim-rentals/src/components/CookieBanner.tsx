  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 max-w-sm w-full px-4 sm:px-0">
      <div className="rounded-2xl border border-slate-800/60 bg-[#0d1117] shadow-[0_8px_40px_rgba(0,0,0,0.7),0_0_0_1px_rgba(69,116,255,0.06)] overflow-hidden">
        <div className="inset-x-0 h-px bg-gradient-to-r from-transparent via-[#10b981]/30 to-transparent" />
        <div className="p-4 flex gap-3">
          <div className="h-8 w-8 rounded-xl bg-[#10b981]/12 border border-[#10b981]/20 flex items-center justify-center shrink-0 mt-0.5">
        ...
        <div className="px-4 pb-4 flex gap-2">
          ...
          <button
            onClick={accept}
            className="flex-1 h-8 rounded-xl bg-[#10b981] text-[12.5px] font-bold text-white hover:bg-[#059669] transition-all active:scale-[0.98]"
          >
            Accept All
          </button>
        </div>
