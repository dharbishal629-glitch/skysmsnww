...
function AuthPage() {
  ...
  const inputCls =
    "w-full h-11 rounded-xl border border-white/[0.14] bg-white/[0.06] text-[14px] text-slate-900 dark:text-white placeholder:text-slate-500 outline-none focus:border-[#10b981]/60 focus:bg-white/[0.09] focus:ring-2 focus:ring-[#10b981]/15 transition-all";
    ...
    <div className="min-h-screen premium-shell flex items-center justify-center px-5 py-10">
      ...
      <div className="pointer-events-none fixed inset-0 z-0" aria-hidden>
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center, rgba(69,116,255,0.12) 0%, transparent 70%)",
            filter: "blur(80px)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center, rgba(0,196,200,0.08) 0%, transparent 70%)",
            filter: "blur(80px)",
          }}
        />
      ...
      <div className="relative z-10 w-full max-w-md modal-content-enter">
        {/* Shimmer accent */}
        <div className="absolute inset-x-0 -top-px h-px bg-gradient-to-r from-transparent via-[#10b981]/50 to-transparent rounded-t-3xl" />
        ...
        <div className="rounded-3xl border border-white/[0.15] bg-white/[0.07] shadow-[0_0_0_1px_rgba(69,116,255,0.12),0_8px_60px_rgba(0,0,0,0.25)] p-8 backdrop-blur-xl">
          ...
          {mode === "choose" && (
            <>
              <div className="text-center mb-7">
                <h1 className="text-[1.75rem] font-black tracking-tight text-[#0a1628] leading-tight">
                  Sign in to SKY SMS
                </h1>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 py-1">
                  ...
                  <span className="text-[11px] text-[#0a1628]/50 font-medium">
                    or
                  </span>
                  <div className="flex-1 h-px bg-[#0a1628]/15" />
                </div>
                ...
                <p className="text-center text-[12px] text-[#0a1628]/60 pt-1">
                  ...
                  <button
                    ...
                    className="text-[#0a1628] hover:text-[#10b981] font-bold transition-colors"
                  >
                    Create one
                  </button>
                </p>
          ...
          {mode === "email-login" && (
            <>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h1 className="text-[17px] font-bold text-[#0a1628] leading-none">
                    Continue with email
                  </h1>
                  <p className="text-[12px] text-[#0a1628]/55 mt-0.5">
              ...
              <form onSubmit={handleEmailAuth} className="space-y-3">
                <div>
                  <label className="block text-[12px] font-bold text-[#0a1628]/60 mb-1.5">
                    Email address
                  </label>
                ...
                <p className="text-center text-[12px] text-[#0a1628]/55">
                  ...
                  <button
                    ...
                    className="text-[#0a1628] font-bold hover:text-[#10b981] transition-colors"
                  >
                    Create one
                  </button>
                </p>
            ...
            <>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-[#0a1628]/55 mt-0.5">
                    Join SKY SMS in under a minute
                  </p>
                </div>
              </div>
              ...
              <form onSubmit={handleEmailAuth} className="space-y-3">
                ...
                <p className="text-center text-[11.5px] text-[#0a1628]/50 leading-relaxed">
                  ...
                  <a
                    href={`${basePath}/terms`}
                    className="text-[#0a1628]/70 hover:text-[#10b981] transition-colors font-medium"
                  >
                    Terms
                  </a>{" "}
                  and{" "}
                  <a
                    href={`${basePath}/refund-policy`}
                    className="text-[#0a1628]/70 hover:text-[#10b981] transition-colors font-medium"
                  >
                    Refund Policy
                  </a>
          ...
          {mode === "2fa" && (
            <>
              <div className="text-center mb-7">
                <div className="h-14 w-14 rounded-2xl bg-[#10b981]/15 border border-[#10b981]/30 flex items-center justify-center mx-auto mb-4">
                  <Shield className="h-7 w-7 text-[#0a1628]" />
                </div>
                <h1 className="text-[1.5rem] font-black tracking-tight text-[#0a1628] leading-tight">
                  Two-Factor Auth
                </h1>
              ...
              <form onSubmit={handle2FA} className="space-y-4">
                <div>
                  <label className="block text-[12px] font-bold text-[#0a1628]/60 mb-2 text-center">
                    Verification code
                  </label>
                  <input
                    type="text"
                    ...
                    placeholder="000000"
                    autoFocus
                    className="w-full h-14 rounded-xl border border-white/[0.14] bg-white/[0.06] text-center font-mono text-[28px] font-bold text-[#0a1628] tracking-[0.25em] outline-none focus:border-[#10b981]/60 focus:ring-2 focus:ring-[#10b981]/15 transition-all backdrop-blur-sm placeholder:text-[#0a1628]/25"
                  />
                </div>
  ...
  return (
    <Suspense fallback={<LoadingSpinner />}>
      <Switch>
        ...
        <Route path="/supportportal" component={AppRoutes} />
        <Route path="/supportportal/conversation/:id" component={AppRoutes} />
